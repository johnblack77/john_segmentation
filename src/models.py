...
class Model(nn.Module):
    ...
    def __init__(self, NUM_CLASS):
        ...
        self.encoder1_c = nn.Sequential(nn.Conv2d(in_channels=64,  out_channels=16,  kernel_size=1, stride=1, padding=0, padding_mode='replicate'), nn.BatchNorm2d(16), nn.ReLU(inplace=True))
        ...
        self.encoder2_c = nn.Sequential(nn.Conv2d(in_channels=128,  out_channels=32,  kernel_size=1, stride=1, padding=0, padding_mode='replicate'), nn.BatchNorm2d(32), nn.ReLU(inplace=True))
        ...
        self.encoder3_c = nn.Sequential(nn.Conv2d(in_channels=256,  out_channels=64,  kernel_size=1, stride=1, padding=0, padding_mode='replicate'), nn.BatchNorm2d(64), nn.ReLU(inplace=True))
        ...
        self.decoder3 = nn.Sequential(
            nn.Conv2d(in_channels=576, out_channels=512, kernel_size=3, stride=1, padding=1, padding_mode='replicate'), nn.BatchNorm2d(512), nn.ReLU(inplace=True),
            nn.Conv2d(in_channels=512, out_channels=256, kernel_size=3, stride=1, padding=1, padding_mode='replicate'), nn.BatchNorm2d(256), nn.ReLU(inplace=True),
            nn.Conv2d(in_channels=256, out_channels=256, kernel_size=3, stride=1, padding=1, padding_mode='replicate'), nn.BatchNorm2d(256), nn.ReLU(inplace=True),
            nn.Conv2d(in_channels=256, out_channels=256, kernel_size=3, stride=1, padding=1, padding_mode='replicate'), nn.BatchNorm2d(256), nn.ReLU(inplace=True)
        )

        self.decoder2 = nn.Sequential(
            nn.Conv2d(in_channels=288, out_channels=256,  kernel_size=3, stride=1, padding=1, padding_mode='replicate'), nn.BatchNorm2d(256), nn.ReLU(inplace=True),
            nn.Conv2d(in_channels=256, out_channels=128 , kernel_size=3, stride=1, padding=1, padding_mode='replicate'), nn.BatchNorm2d(128), nn.ReLU(inplace=True),
        )

        self.decoder1 = nn.Sequential(
            nn.Conv2d(in_channels=144, out_channels=128, kernel_size=3, stride=1, padding=1, padding_mode='replicate'), nn.BatchNorm2d(128), nn.ReLU(inplace=True),
            nn.Conv2d(in_channels=128, out_channels=64, kernel_size=3, stride=1, padding=1, padding_mode='replicate'), nn.BatchNorm2d(64), nn.ReLU(inplace=True),
        )
